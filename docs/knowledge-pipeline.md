...
(Full template set covers all 200+ relations.)
...
- Add 70 more relations: sports, entertainment, business, science, food, history, animals, education
...
- Ingest full Wikidata dump filtered to top 500 properties
...
- Community-contributed domain-specific triple sets
- Automated probe runner for new HuggingFace models
- Cross-lingual triples: French, German, Spanish, Chinese, Japanese, Korean
