...
impl MetalBackend {
    ...
    pub fn decode_token_split_profile(
            ...
            timed_cmd!(t_attn, enc, {
                ...
                if uses_q4k {
                    ...
                    if uniform_q4k {
                        ...
                        let (q_rows_u, k_rows_u, v_rows_u, k_u) =
                            (q_dim as u32, kv_dim as u32, kv_dim as u32, hidden as u32);
                ...
                if uses_q4k {
                    ...
                    enc.set_buffer(0, Some(&attn_out_buf), 0);
                    enc.set_buffer(1, Some(&o_q8_scratch), 0);
                    ...
                    enc.set_buffer(3, Some(&o_q8s_scratch), 0);
            ...
            timed_cmd!(t_gate_up, enc, {
                if ffn_is_q4kf {
                    if layer.is_gated() {
                        ...
                        enc.set_buffer(3, Some(&gate_out_scratch), 0);
                        ...
                        enc.set_buffer(0, Some(&gate_out_scratch), 0);
                        ...
                        let act_pipe = match layer.activation {
        ...
        eprintln!(
            ...
            t_attn / num_layers as f64,
            t_gate_up / num_layers as f64,
            t_down / num_layers as f64,
        );
