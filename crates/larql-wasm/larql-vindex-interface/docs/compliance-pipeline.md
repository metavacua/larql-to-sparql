...
| Compliance toolchain (`REUSE.toml`, `cog.toml`, `cliff.toml`, `.github/workflows/`, `scripts/`, `crates/larql-vindex/docs/*-pipeline.md`, `deny.toml`, `NOTICE`, `CONTRIBUTING.md`) | Copyright (C) 2026 Ian Douglas Lawrence Norman McLean | Apache-2.0 | toolchain PR series |
...
crates/larql-vindex/docs/compliance-pipeline.md       # this file
crates/larql-vindex/docs/code-quality-pipeline.md     # quality.yml operator reference
```
