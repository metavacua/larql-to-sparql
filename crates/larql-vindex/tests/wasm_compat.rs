// Ported from crates/larql-vindex/tests/architecture_contracts.rs with cfg_attr dual annotation.
// All test bodies are identical to the native suite; failures in wasm-test are forensic data.
